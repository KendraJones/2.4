describe("Testing the calculator", () => {
    ...
    test("Addition works", () => {
      expect(calculator.add(17, 33)).toBe(50);
    });
    test("Subtraction works", () => {
      expect(calculator.subtract(898, 44)).toBe(854);
    });
    test("Multiplication works", () => {
      expect(calculator.multiply(5, 55)).toBe(275);
    });
    test("Division works", () => {
    ...
    describe("Stretch Goals", () => {
      ...
      test("(28/4)*(6/2)*(30-27+(3-4)) == 42", () => {
        expect(calculator.multiply(calculator.multiply(7, 3), 2)).toBe(42);
      });
    });
  });
